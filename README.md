...
ПО обращается датасет techniques Mitre
№ techniques найдена?
если нет, то Вывод сообщения об ошибке поиска
Конец
если да, то ПО обращается датасет CAPEC
...
Начало
Ввод: ID CAPEC
ПО обращается датасет CAPEC
ID CAPEC найден?
если нет, то Вывод сообщения об ошибке поиска
Конец
если да, то ПО обращается датасет CWE
Результат Galeax-CVE2CAPEC
ID CWE найден?
если нет, то Вывод пустого значения
Конец
...
Начало
Ввод: ID CWE
ПО обращается датасет CWE
ID CWE найден?
если нет, то Вывод сообщения об ошибке поиска
Конец
если да, то Galeax-CVE2CAPEC обновляет датасет CVE
ПО обращается датасет CVE
Результат Galeax-CVE2CAPEC
ID CVE найден?
если нет, то Вывод пустого значения
Конец
